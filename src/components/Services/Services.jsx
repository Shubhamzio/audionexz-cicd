...
const Service = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Strategic acoustic planning for open offices, boardrooms, and collaborative zones — reducing noise distraction by up to 65%.",
      highlights: [
    ...
    },
    {
      ...
      description:
        "Dolby Atmos certified home theatre design with calibrated acoustics, 4K laser projection, and automated ambient control.",
      highlights: [
    ...
    },
    {
      ...
      description:
        "Acoustic engineering for restaurants, hotels, and lounges — balancing speech intelligibility with curated sonic atmospheres.",
      highlights: [
        "Ambient Noise Sculpting",
    ...
    },
    {
      ...
      description:
        "Large-format venue design with variable acoustic systems, ensuring every seat delivers an immersive auditory experience.",
      highlights: [
    ...
    },
    {
      ...
      description:
        "Comprehensive acoustic assessments with 3D simulation modeling, regulatory compliance audits, and actionable design recommendations.",
      highlights: [
    ...
    },
    {
      ...
      description:
        "Purpose-built podcast and broadcast environments with vocal-optimized acoustics, remote recording infrastructure, and live streaming capability.",
      highlights: [
        "Vocal Booth Engineering",
    ...
    },
    {
      ...
      description:
        "Soundproofed practice spaces with instrument-specific acoustic tuning, integrated recording capability, and adjustable diffusion.",
      highlights: [
        "Full Soundproofing",
  ...
  const processSteps = [
    {
      num: "01",
      title: "Discovery",
      desc: "Deep-dive consultation to map your acoustic vision, spatial constraints, and performance targets.",
    },
    {
      num: "02",
      title: "Analysis",
      desc: "On-site acoustic measurement suite — RT60, frequency response, noise floor, and structural assessment.",
    },
    {
      num: "03",
      title: "Design",
      desc: "3D acoustic modeling with ray-tracing simulations and material performance optimization.",
    },
    {
      num: "04",
      title: "Build",
      desc: "Precision installation by certified acoustic engineers with real-time quality monitoring.",
    },
    {
      num: "05",
      title: "Calibrate",
      desc: "Post-installation measurement, fine-tuning, and performance certification against design targets.",
    },
    {
      num: "06",
      title: "Sustain",
      desc: "Ongoing acoustic health monitoring, seasonal recalibration, and priority support access.",
    },
  ];
      ...
      <section className="srv-hero" ref={heroRef}>
        <div className="srv-hero-inner">
          ...
          <h1 className="srv-hero-title srv-animate">
            ...
            <span className="srv-title-row srv-title-accent">
              Perfect Sound
            </span>
          </h1>
        ...
        <div className="srv-container">
          ...
          <div className="srv-process-grid">
            {processSteps.map((step, i) => (
              <div
                key={i}
                className="srv-process-card srv-animate"
        ...
        <div className="srv-modal-overlay" onClick={closeModal}>
          ...
          >
            ...
            <div className="srv-modal-body">
              <div
                className="srv-modal-accent-bar"
                style={{ background: selectedService.gradient }}
              />
              <div className="srv-modal-top">
                <span className="srv-modal-cat">
                  {selectedService.category}
                </span>
                <span className="srv-modal-metric-badge">
              ...
              <div className="srv-modal-info-grid">
                <div className="srv-modal-info-block">
                  ...
                  <span className="srv-modal-info-value">
