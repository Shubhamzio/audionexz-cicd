...
const Home = () => {
  ...
  const partnerLogos = [
    { id: 1, name: "Antelope", logo: getImagePath("/assets/antelope.jpg") },
    {
      id: 2,
      name: "Audio Technica",
      logo: getImagePath("/assets/audio_tech.png"),
    },
    {
      id: 3,
      name: "Audioease",
      logo: getImagePath("/assets/audio_e.png"),
    },
    { id: 4, name: "Audix", logo: getImagePath("/assets/audix.png") },
    ...
    { id: 7, name: "Beta Three", logo: getImagePath("/assets/beta_three.png") },
    {
      id: 8,
    ...
    { id: 14, name: "JBL", logo: getImagePath("/assets/JBL-Logo.svg.png") },
    {
      id: 15,
      name: "K&M",
      logo: getImagePath("/assets/Konig_meyer.png"),
    },
    { id: 16, name: "KRK", logo: getImagePath("/assets/krk.png") },
    { id: 17, name: "Lewitt", logo: getImagePath("/assets/lewitt.png") },
    {
      id: 18,
      name: "Lexicon",
      logo: getImagePath("/assets/lexicon.png"),
    },
    {
      id: 19,
    ...
    { id: 20, name: "Manley", logo: getImagePath("/assets/manley.png") },
    {
      id: 21,
      name: "Neumann",
      logo: getImagePath("/assets/neuman.png"),
    },
    {
      id: 22,
      name: "Prism Sound",
    ...
    },
    {
      ...
      logo: getImagePath("/assets/sound_ref.png"),
    },
    ...
    },
    {
      ...
      logo: getImagePath("/assets/ultimate.png"),
    },
  ...
  const testimonials = [
    ...
    },
    {
      ...
      text: "AudioNexz is the perfect blend of premium equipment, expert guidance, stellar service, and flawless acoustics.",
    },
    {
      id: 7,
    ...
    },
    {
      ...
      text: "Visited Neobalad Studio once and the experience was absolutely mesmerizing — the acoustics, the ambiance, and the setup left me completely speechless",
    },
    {
      id: 10,
      name: "Shamidh Mukherjee",
      role: "Vocalist, Music Director",
      avatar: getImagePath("/assets/Shamid_Ch.jpeg"),
    ...
    },
    {
      ...
      text: " Every instrument and studio gear you could ever dream of, all under one roof, with an experience that's truly unmatched.",
    },
    {
      id: 12,
      name: "Raja Chowdhury",
      ...
      text: "Neobalad Studio is where sound meets perfection — breathtaking acoustics, premium equipment, and an immersive audio experience like no other",
    },
    {
      id: 13,
      ...
      text: "flawless acoustics, pristine sound, and world-class equipment — a true benchmark in acoustic excellence.",
    },
  ];
    ...
    <div className="audionexz-home__wrapper">
      ...
      <section className="audionexz-home__ventures">
        <div className="audionexz-home__ventures-container">
          <h2
            className="audionexz-home__ventures-heading"
          ...
          <div className="audionexz-home__ventures-cards">
            ...
            <div className="audionexz-home__ventures-card">
              <img
                src={getImagePath("/assets/Das_m.png")}
