            ...
            {founders.map((founder, index) => (
              ...
              >
                <div className="anx-about__founder-image-wrapper">
                  ...
                  <div className="anx-about__founder-image-frame">
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = `https://ui-avatars.com/api/?name=${founder.name.replace(' ', '+')}&size=400&background=1e90ff&color=fff&bold=true`;
                      }}
                    />
                  </div>
                ...
                <div className="anx-about__founder-content">
                  ...
                  <div className="anx-about__founder-social">
                    <a href={`mailto:${founder.social.email}`} className="anx-about__founder-social-link">
                      <svg viewBox="0 0 24 24" fill="currentColor">
                        <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                      </svg>
                    </a>
                    <a href={founder.social.linkedin} className="anx-about__founder-social-link">
                      <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="anx-about__story-visual anx-about__animate">
            <div className="anx-about__story-image-grid">
              <div className="anx-about__story-image-item anx-about__story-image-item--1">
                <img src="/assets/about/studio-1.jpg" alt="Studio" />
              </div>
              <div className="anx-about__story-image-item anx-about__story-image-item--2">
                <img src="/assets/about/equipment.jpg" alt="Equipment" />
              </div>
              <div className="anx-about__story-image-item anx-about__story-image-item--3">
                <img src="/assets/about/installation.jpg" alt="Installation" />
              </div>
            </div>
          </div>
        </div>
