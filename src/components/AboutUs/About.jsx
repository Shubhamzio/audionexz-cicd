  ...
  const services = [
    {
      ...
      description:
        "Premium instruments from world-leading brands for professionals and enthusiasts.",
    },
    {
      icon: "🎙️",
      title: "Studio Equipment",
      description:
        "Professional recording, mixing, and mastering equipment for studios.",
    },
    {
      icon: "🔊",
      title: "Live Sound Systems",
      description:
        "Complete PA, monitoring, and live performance audio solutions.",
    },
    {
      icon: "🎨",
      title: "Acoustic Design",
      description:
        "Expert acoustic treatment, soundproofing, and room optimization.",
    },
    {
      icon: "🔧",
      title: "Installation & Setup",
      description:
        "Professional installation, calibration, and system integration.",
    },
    {
      icon: "🎯",
      title: "Consultation",
        ...
        <section className="anx-about__hero">
          ...
          <div className="anx-about__hero-content">
            ...
            <h1 className="anx-about__hero-title anx-about__animate">
              About{" "}
              <span className="anx-about__hero-title--highlight">
                AUDIONEXZ
              </span>
            </h1>

            <p className="anx-about__hero-subtitle anx-about__animate">
              Your premier destination for professional audio solutions,
              acoustic design, and world-class sound system installations.
            </p>
          ...
          <div className="anx-about__founders-container">
            <div className="anx-about__founders-header anx-about__animate">
              ...
              <h2 className="anx-about__section-title">
                Meet Our{" "}
                <span className="anx-about__section-title--highlight">
                  Founders
                </span>
              </h2>
              ...
              {founders.map((founder, index) => (
                ...
                >
                  ...
                  <div className="anx-about__founder-content">
                    ...
                    <span className="anx-about__founder-role">
                      {founder.role}
                    </span>
                    <p className="anx-about__founder-description">
                      {founder.description}
                    </p>
                  </div>
                </div>
          ...
          <div className="anx-about__story-container">
            <div className="anx-about__story-content anx-about__animate">
              ...
              <div className="anx-about__story-text">
                <p>
                  At <strong>AUDIONEXZ</strong>, we bring together the worlds of
                  music, technology, and acoustics to deliver the finest in
                  professional sound. Based in
                  <strong> Khardah, West Bengal, India</strong>, we specialize
                  in musical instruments, studio gear, live sound systems,
                  acoustic design, and professional speaker installations for
                  every kind of space.
                </p>
                <p>
                  Founded by <strong>Tanmoy Das</strong> and{" "}
                  <strong>Megha Mukherjee</strong>, AUDIONEXZ is driven by a
                  shared passion for quality sound, design precision, and
                  reliable performance. Whether you're a musician, a studio
                  owner, or a business creating a high-end venue experience, our
                  team provides end-to-end consultation, equipment supply,
                  installation, and calibration to ensure your sound is tuned to
                  perfection.
                </p>
              </div>
              ...
              <div className="anx-about__story-quote">
                <svg
                  className="anx-about__story-quote-icon"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
            ...
            <div className="anx-about__services-grid">
              {services.map((service, index) => (
                ...
                >
                  ...
                  <p className="anx-about__service-description">
                    {service.description}
                  </p>
        ...
        <section className="anx-about__brands">
          <div className="anx-about__brands-container">
            <div className="anx-about__brands-header anx-about__animate">
              ...
              <p className="anx-about__section-description">
                We proudly work with over{" "}
                <strong>200 world-leading pro-audio brands</strong>, ensuring
                every solution meets international standards.
              </p>
            </div>
            ...
            <div className="anx-about__brands-marquee">
              <div className="anx-about__brands-track">
                {[...brands, ...brands].map((brand, index) => (
                  <span key={index} className="anx-about__brand-item">
                    {brand}
                  </span>
                ))}
              </div>
        ...
        <section className="anx-about__expertise">
          <div className="anx-about__expertise-container">
            <div className="anx-about__expertise-content anx-about__animate">
              ...
              <h2 className="anx-about__expertise-title">
                Professional Excellence
              </h2>
              <p className="anx-about__expertise-text">
                From <strong>Dolby Atmos studios</strong> to commercial venue
                sound systems, AUDIONEXZ ensures clarity, depth, and consistency
                in every project. With our expertise in acoustics, calibration,
                and system integration, we help clients achieve perfect sound
                that transforms their space.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="anx-about__cta">
          <div className="anx-about__cta-container anx-about__animate">
            <div className="anx-about__cta-content">
              <h2 className="anx-about__cta-title">
                Ready to Transform Your Sound?
              </h2>
              <p className="anx-about__cta-text">
                Let's create the perfect audio experience together
              </p>
              <button
                className="anx-about__cta-button"
